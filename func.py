...
x1 = div(add(neg(b),sqrt(sub(exp(b,2),mult(4,a,c)))), mult(2,a,1))# TODO: write a code to compute the first root of the quadratic equation
x2 = div(sub(neg(b),sqrt(sub(exp(b,2),mult(4,a,c)))), mult(2,a,1)) # TODO: then do the same for the second root
